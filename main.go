...
func mainWithError() (err error) {
	...
	daemonCommand.PersistentFlags().StringSlice(f.Service.App.ExtraAnnotations, []string{}, "List of extra annotations to be added to each App CR. Format 'key:value,key2:value2'.")
